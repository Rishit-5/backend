...
document.getElementById("Submit").onclick = function(){
    ...
    fetch(
        ...
        "https://gorgeous-pink-galoshes.cyclic.cloud/" + player + "/" + stat  //use "http://localhost:3000" if running sample express backend locally, or replace with your own backend endpoint url
